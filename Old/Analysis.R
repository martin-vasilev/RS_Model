...
ggsave(plot = G1, filename = 'plots/Line_length1.pdf', width = 9, height = 7)
...
ggsave(plot = G2, filename = 'plots/font_size1.pdf', width = 9, height = 7)
...
ggsave(plot = G3, filename = 'plots/launch.pdf', width = 9, height = 7)
...
ggsave(filename = 'Plots/M1_merged.pdf', plot = figure, width = 18, height = 7)
...
ggsave(plot = U1, filename = 'plots/USPLine_length1.pdf', width = 9, height = 7)
...
ggsave(plot = U2, filename = 'plots/USPfont_size1.pdf', width = 9, height = 7)
...
ggsave(plot = U3, filename = 'plots/USPlaunch.pdf', width = 9, height = 7)
...
ggsave(filename = 'Plots/M1_USPmerged.pdf', plot = figure, width = 18, height = 7)
...
figure2<- annotate_figure(figure2,
                         top = text_grob("Model saccade target: left margin", color = "black", face = "bold", size = 18))
ggsave(filename = 'Plots/M1_USPmerged.png', plot = figure2, width = 16, height = 12)
